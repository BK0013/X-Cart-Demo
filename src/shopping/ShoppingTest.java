...
public class ShoppingTest extends Utility {
    ...
    public void verifyThatUserShouldPlaceOrderSuccessfullyForCupOfMojoBluetoothSpeaker() throws InterruptedException {
        ...
        clickOnElement(By.xpath("//a[contains(text(),'Avengers: Fabrikations Plush')]/parent::h5/following-sibling::div//button"));
...
//verify subtotal
        ...
        sendTextToElement(By.xpath("//input[@id='email']"), "bkpatel13@yahoo.com");
        ...
        sendTextToElement(By.xpath("//input[@id='shippingaddress-firstname']"), "BK");
        sendTextToElement(By.xpath("//input[@id='shippingaddress-lastname']"), "Patel");
        sendTextToElement(By.xpath("//input[@id='shippingaddress-street']"), "1, High Street");
        sendTextToElement(By.xpath("//input[@id='shippingaddress-city']"), "London");
        selectValueFromdropDown(By.xpath("//select[@id='shippingaddress-country-code']"), "CBZ");
        sendTextToElement(By.xpath("//input[@id='shippingaddress-custom-state']"), "BKcorp");
        sendTextToElement(By.xpath("//input[@id='shippingaddress-zipcode']"), "AB10 8ED");
        clickOnElement(By.xpath("//input[@id='create_profile']")); // checkbox
        sendTextToElement(By.xpath("//input[@id='password']"), "BK1234");
        Thread.sleep(5000);
        // clickOnElement(By.xpath("//input[@id='same_address']"));
        //  mouseHoverToElement(By.xpath("//input[@id='method128']"));
        // clickOnElement(By.xpath("//label[@title='Local shipping']/input"));
        ...
        clickOnElement(By.xpath("//span[normalize-space()='Place order: $52.30']"));
